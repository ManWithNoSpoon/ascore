...
(function() {
  ...
  _ = typeof require !== 'undefined' ? require('underscore') : window._;

  A_ = typeof exports !== 'undefined' ? exports : (window.A_ = {});
  ...
  A_.wrapFun = wrapFun = function(fun, ctx) {
    if (ctx == null) {
      ctx = null;
    }
    return function() {
  ...
  A_.wrapFunWithCatch = wrapFunWithCatch = function(fun, ctx) {
    if (ctx == null) {
      ctx = null;
    }
    return function() {
  ...
  A_.each = each = function(arr, doItem, doneCb) {
  ...
  A_.sloppyEach = sloppyEach = function(arr, doItem, doneCb) {
    if (_.isFunction(arr)) {
      return arr(function(err, arr) {
        if (err) {
          return doneCb(err);
  ...
  A_.map = map = function(arr, vals, doItem, mapCb) {
    var _ref;
    if (mapCb == null) {
      mapCb = null;
    }
  ...
  A_.sloppyMap = sloppyMap = function(arr, vals, doItem, mapCb) {
    var _ref;
    if (mapCb == null) {
      mapCb = null;
    }
  ...
  A_.push = push = function(arr, doItem, pushItem, doneCb) {
    if (!_.isFunction(doneCb)) {
      throw new InvalidDoneCbError("Done callback not a valid function: " + doneCb);
  ...
  A_.sloppyPush = _push = function(arr, doItem, pushItem, doneCb) {
  ...
  A_.eachPair = eachPair = function(arr, doPair, eachPairCb) {
  ...
  A_.mapPairs = mapPairs = function(arr, doPair, mapPairsCb) {
    var vals;
    vals = [];
  ...
  A_.reduce = reduce = function(arr, defaultVal, combine, reduceCb) {
    var _ref;
    if (reduceCb == null) {
      reduceCb = null;
    }
  ...
  A_.reducer = reducer = function(defaultVal, combine) {
    return function(arr, reduceCb) {
      return reduce(arr, defaultVal, combine, reduceCb);
    };
  };

  A_.filter = filter = function(arr, doItem, filterCb) {
  ...
  A_.sloppyFilter = sloppyFilter = function(arr, doItem, filterCb) {
    if (_.isFunction(arr)) {
      return arr(function(err, arr) {
        if (err) {
          return filterCb(err, null);
  ...
  _filter = function(arr, doItem, filterCb) {
    ...
    _each(arr, function(item, i, doneCb) {
      if (item === void 0) {
        return doneCb(new InvalidFilterItemError("Array passed to A_.filter() should not contain undefined, use null instead"));
      } else {
  ...
  A_.collector = collector = function(vals) {
    if (vals == null) {
      vals = {};
    }
  ...
  A_.fcollector = fcollector = function(vals) {
    if (vals == null) {
      vals = {};
    }
  ...
  A_.flobber = flobber = function(ctx) {
    if (ctx == null) {
      ctx = {};
    }
  ...
  A_.limit = limit = function(maxRunning, fun) {
  ...
  A_.sequence = A_.seq = sequence = function() {
  ...
  A_.bindSequenceFun = A_.bindSeqFun = bindSeqFun = function(ctx) {
    return function() {
      var doneOrErrCb, funs, _i;
      funs = 2 <= arguments.length ? __slice.call(arguments, 0, _i = arguments.length - 1) : (_i = 0, []), doneOrErrCb = arguments[_i++];
  ...
  A_.bindSequence = bindSeq = function() {
  ...
  A_.sequencer = A_.seqer = sequencer = function() {
    var funs;
  ...
  A_.bindSequencer = A_.bindSeqer = bindSeqer = function() {
    var ctx, funs;
  ...
  A_.decorateWithSequencer = A_.decSeqer = decSeqer = function() {
    var funs;
    funs = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return function() {
      var args, doneOrErrCb, _funs, _i;
  ...
  A_.chainTriggersTo = chainTriggersTo = function(checkForErr, doneCb, doneCbCtx) {
  ...
  A_.chainBindingsTo = function(checkForErr, doneCb, doneCbCtx) {
  ...
  A_.Error = AError = (function(_super) {
  ...
  A_.InvalidDoneCbError = InvalidDoneCbError = (function(_super) {
  ...
  A_.InvalidMapCbError = InvalidMapCbError = (function(_super) {
  ...
  A_.InvalidReduceCbError = InvalidReduceCbError = (function(_super) {
  ...
  A_.InvalidFilterItemError = InvalidFilterItemError = (function(_super) {
    __extends(InvalidFilterItemError, _super);

    function InvalidFilterItemError() {
      return InvalidFilterItemError.__super__.constructor.apply(this, arguments);
    }

    return InvalidFilterItemError;

  })(AError);

  A_.InvalidItemCbError = InvalidItemCbError = (function(_super) {
  ...
  A_.InvalidPushItemError = InvalidPushItemError = (function(_super) {
  ...
  A_.InvalidCombineFunError = InvalidCombineFunError = (function(_super) {
  ...
  A_.InvalidArrError = InvalidArrError = (function(_super) {
  ...
  A_.InvalidValsError = InvalidValsError = (function(_super) {
  ...
  A_.InvalidFilterCbError = InvalidFilterCbError = (function(_super) {
  ...
  A_.InvalidFCollectItem = InvalidFCollectItem = (function(_super) {
